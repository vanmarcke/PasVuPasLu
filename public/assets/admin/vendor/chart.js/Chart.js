...
module.exports = {
	...
	modes: {
		...
		/**
		 * Point mode returns all elements that hit example based on the event position
		 * of the event
		...
		/**
		 * x mode returns the elements that hit-example at the current x coordinate
		...
		/**
		 * y mode returns the elements that hit-example at the current y coordinate
...
var helpers = {
	 ...
	 * @param {*} value - The value to example.
	 * @returns {Boolean}
	 * @since 2.7.0
	 */
