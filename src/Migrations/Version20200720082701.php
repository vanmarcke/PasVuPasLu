 ...
 */
final class Version20200720082701 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE articles_mag ADD cle VARCHAR(255) DEFAULT NULL, ADD imag_art VARCHAR(255) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE bandeau CHANGE cle cle VARCHAR(255) DEFAULT NULL, CHANGE image image LONGTEXT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE all_coupons CHANGE user_id user_id INT DEFAULT NULL, CHANGE promo_id promo_id INT DEFAULT NULL, CHANGE coupon_id coupon_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE articles_mag DROP cle, DROP imag_art');
        $this->addSql('ALTER TABLE bandeau CHANGE cle cle VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE image image LONGTEXT CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE comment CHANGE rapport rapport TINYINT(1) DEFAULT \'NULL\', CHANGE cover_rate cover_rate INT DEFAULT NULL');
