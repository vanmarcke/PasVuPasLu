 ...
 */
final class Version20190618165425 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE editeur ADD file_image_cadr VARCHAR(255) NOT NULL, CHANGE url url VARCHAR(255) DEFAULT NULL, CHANGE create_at create_at DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE comment CHANGE rapport rapport TINYINT(1) DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE editeur DROP file_image_cadr, CHANGE url url VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE create_at create_at DATETIME DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE forum CHANGE forums_id forums_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE forum_reply CHANGE forum_id forum_id INT DEFAULT NULL, CHANGE user_post_id user_post_id INT DEFAULT NULL');
