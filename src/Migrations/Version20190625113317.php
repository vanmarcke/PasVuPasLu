 ...
 */
final class Version20190625113317 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE question ADD images VARCHAR(100) DEFAULT NULL, CHANGE editeur_id editeur_id INT DEFAULT NULL, CHANGE title title VARCHAR(191) DEFAULT NULL, CHANGE interView_id interView_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE question DROP images, CHANGE editeur_id editeur_id INT DEFAULT NULL, CHANGE title title VARCHAR(191) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE interView_id interView_id INT DEFAULT NULL');
