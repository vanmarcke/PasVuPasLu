 ...
 */
final class Version20190618181654 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE interView ADD ilustration VARCHAR(255) NOT NULL, CHANGE url url VARCHAR(100) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE interView DROP ilustration, CHANGE url url VARCHAR(100) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci');
