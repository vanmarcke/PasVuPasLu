 ...
 */
final class Version20200623083400 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE prices CHANGE title title VARCHAR(100) NOT NULL, CHANGE text text VARCHAR(20) NOT NULL, CHANGE photo photo LONGTEXT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE prices CHANGE title title VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE text text VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE photo photo VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE private_message CHANGE user_sender_id user_sender_id INT DEFAULT NULL, CHANGE is_head is_head TINYINT(1) DEFAULT \'NULL\', CHANGE is_view is_view TINYINT(1) DEFAULT \'NULL\'');
