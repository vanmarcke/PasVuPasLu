 ...
 */
final class Version20191001171359 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE all_coupons ADD adddate_at DATETIME NOT NULL, CHANGE user_id user_id INT DEFAULT NULL, CHANGE coupon_id coupon_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE all_coupons DROP adddate_at, CHANGE user_id user_id INT DEFAULT NULL, CHANGE coupon_id coupon_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE comment CHANGE rapport rapport TINYINT(1) DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE coupon CHANGE is_valid is_valid TINYINT(1) DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE coupon_livre CHANGE is_valid is_valid TINYINT(1) DEFAULT \'NULL\'');
        ...
        $this->addSql('ALTER TABLE livres CHANGE video video VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci');
