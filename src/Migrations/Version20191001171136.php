 ...
 */
final class Version20191001171136 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE coupon ADD is_valid TINYINT(1) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE all_coupons CHANGE user_id user_id INT DEFAULT NULL, CHANGE coupon_id coupon_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE all_coupons CHANGE user_id user_id INT DEFAULT NULL, CHANGE coupon_id coupon_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE comment CHANGE rapport rapport TINYINT(1) DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE coupon DROP is_valid');
        $this->addSql('ALTER TABLE coupon_livre CHANGE is_valid is_valid TINYINT(1) DEFAULT \'NULL\'');
