 ...
 */
final class Version20200720101727 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE contact ADD captcha_code VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE comment CHANGE rapport rapport TINYINT(1) DEFAULT \'NULL\', CHANGE cover_rate cover_rate INT DEFAULT NULL');
        $this->addSql('ALTER TABLE contact DROP captcha_code');
