 ...
 */
final class Version20200624131400 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE news DROP ordre');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE news ADD ordre VARCHAR(1) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`');
