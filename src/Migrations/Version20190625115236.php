 ...
 */
final class Version20190625115236 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE question CHANGE editeur_id editeur_id INT DEFAULT NULL, CHANGE title title VARCHAR(191) DEFAULT NULL, CHANGE question question VARCHAR(255) DEFAULT NULL, CHANGE response response LONGTEXT DEFAULT NULL, CHANGE interView_id interView_id INT DEFAULT NULL, CHANGE images images VARCHAR(100) DEFAULT NULL');
