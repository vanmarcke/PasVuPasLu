 ...
 */
final class Version20200721120437 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE articles_mag CHANGE cle cle VARCHAR(255) DEFAULT NULL, CHANGE imag_art imag_art VARCHAR(255) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE content ADD link VARCHAR(255) DEFAULT NULL, CHANGE cle cle VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE all_coupons CHANGE user_id user_id INT DEFAULT NULL, CHANGE promo_id promo_id INT DEFAULT NULL, CHANGE coupon_id coupon_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE articles_mag CHANGE cle cle VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE imag_art imag_art VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE bandeau CHANGE cle cle VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE comment CHANGE rapport rapport TINYINT(1) DEFAULT \'NULL\', CHANGE cover_rate cover_rate INT DEFAULT NULL');
        $this->addSql('ALTER TABLE content DROP link, CHANGE cle cle VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE coupon CHANGE is_valid is_valid TINYINT(1) DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE coupon_livre CHANGE is_valid is_valid TINYINT(1) DEFAULT \'NULL\'');
