 ...
 */
final class Version20200710082635 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE comment ADD cover_rate INT DEFAULT NULL, CHANGE rapport rapport TINYINT(1) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE all_coupons CHANGE user_id user_id INT DEFAULT NULL, CHANGE promo_id promo_id INT DEFAULT NULL, CHANGE coupon_id coupon_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE comment DROP cover_rate, CHANGE rapport rapport TINYINT(1) DEFAULT \'NULL\'');
