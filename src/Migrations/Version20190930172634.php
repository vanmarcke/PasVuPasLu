 ...
 */
final class Version20190930172634 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE all_coupons (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, promo_id INT NOT NULL, coupon_id INT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE all_coupons');
        $this->addSql('ALTER TABLE comment CHANGE rapport rapport TINYINT(1) DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE coupon_livre CHANGE is_valid is_valid TINYINT(1) DEFAULT \'NULL\'');
